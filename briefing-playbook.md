...
- 快讯类 feed（金十数据、联合早报、风向旗、竹新社）：**看标题即可**，偶尔读正文。金十每天有大量模板噪音（`https://www.jin10.com/`、「金十图示」「期货热点追踪」「A股温度计」「XX价格追踪」「VIP事件提醒」「十分钟后公布」等），扫标题时直接跳过；真正有信息量的是带具体数字的快讯与「金十数据整理：每日科技要闻速递 / 中东局势跟踪 / 俄乌冲突跟踪」，这三类建议读正文（一条顶十条）。三类的发布时点固定：中东/俄乌跟踪约 05:30–05:50 发布**当天**内容，科技要闻速递约次日早 07:30 发布**前一日**内容——所以 06:00 执行时拿到的最新一期速递仍是前一天的（实测 2026-09-16：中东、俄乌跟踪是 9 月 16 日版，科技速递最新只到 9 月 14 日版），不要把「科技速递日期比跟踪早一天」当成漏抓。**周末例外**：周六与周日的三类综述发布明显更晚，06:00 执行时当天那期还没出（实测：2026-09-12 周六 09:15/09:20/09:31、2026-09-13 周日 08:38/08:42/08:53，2026-09-14 周一恢复到 05:31；2026-09-19 周六 06:00 执行时窗口内最新一期仍是 9-18 的 05:23 中东跟踪与 07:37 科技速递，当天那期确实尚未发布）——这不算抓取失败，别写成漏抓，直接用已有的最新一期加当天的即时快讯成稿。
